...
- **CREDIT_CARD เพิ่ม:** ต้องมี `creditLimit` (≥ 0), `interestRate` (≥ 0), `cardAccountType`
...
- **Info Card:** ยอดคงเหลือ (หรือยอดค้างชำระสำหรับบัตรเครดิต), วันที่รายการล่าสุด
- **Quick Actions:** แก้ไข, ชำระ (บัตรเครดิต), ปิดบิล (บัตรเครดิต), บันทึกว่าตรวจสอบแล้ว
