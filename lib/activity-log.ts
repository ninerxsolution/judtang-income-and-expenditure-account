...
export const ActivityLogAction = {
  ...
  BUDGET_TEMPLATE_CREATED: "BUDGET_TEMPLATE_CREATED",
  BUDGET_TEMPLATE_UPDATED: "BUDGET_TEMPLATE_UPDATED",
  BUDGET_TEMPLATE_DELETED: "BUDGET_TEMPLATE_DELETED",
  BUDGET_MONTH_APPLIED_TEMPLATE: "BUDGET_MONTH_APPLIED_TEMPLATE",
  BUDGET_MONTH_UPDATED: "BUDGET_MONTH_UPDATED",
