export const enDictionary = {
  ...
  dashboard: {
    ...
    spendingEfficiency: {
      subtitle: "See how well you turn income into savings, where your money goes, and whether you are improving month over month.",
      periodPrev: "Previous",
      periodNext: "Next",
      noData: "No data in this range.",
      loadFailed: "Failed to load data.",
      savingsRate: "Savings rate",
      savingsRateSub: "Saved {saved} of {income} income",
      vsPrevMonth: "{delta} vs last month",
      noPrevMonth: "No previous month to compare yet.",
      targetHint: "Healthy target ≥ 20%",
      targetLine: "Line = 20% target",
      bandNegative: "Negative",
      bandTight: "Tight",
      bandOk: "Okay",
      bandStrong: "Strong",
      structureTitle: "Money structure",
      structureRef: "Based on the 50 / 30 / 20 rule",
      needs: "Needs",
      wants: "Wants",
      savings: "Savings",
      needsTarget: "target 50%",
      wantsTarget: "target 30%",
      savingsTarget: "target 20%",
      topCategoriesTitle: "Top spending drivers",
      topCategoriesSub: "% of spending · vs last month",
      noExpense: "No spending this month.",
      newBadge: "new",
      trendTitle: "Savings rate trend",
      trendSub: "Monthly, this year",
      classifyTitle: "Classify: needs vs wants",
      classifySub: "Pick the 'needs' categories — the rest count as 'wants' automatically.",
      classifyAllNeed: "Mark all as needs",
      classifyReset: "Reset (all wants)",
    ...
    slipUpload: {
      ...
      engineLabel: "Slip reader:",
      engineCloud: "Online (default)",
      engineLocal: "On-device (beta)",
      engineLocalHint: "Runs on your device — free and unlimited, but slower and less accurate. The first run downloads language data.",
      retry: "Retry ({count} left)",
      retryExhausted: "Retried 3 times",
      errorDuplicate: "This slip is already uploaded",
      duplicateSkipped: "Skipped {count} duplicate slip(s)",
  ...
  summary: {
    ...
    net: "Net",
    netSurplus: "Surplus this period",
    netDeficit: "Spending over income",
    vsPrevMonth: "{delta} vs last month",
    annualAverages: "Annual averages {year}",
    chart: {
  ...
  notifications: {
    ...
    types: {
      ...
      EVENT_EXPORT_DONE: "Export ready",
      EVENT_EXPORT_DONE_body: "Your export of {count} transaction(s) is ready",
      EVENT_CARD_STATEMENT_CLOSED: "Statement closed",
      EVENT_CARD_STATEMENT_CLOSED_body:
        "{accountName}: balance ฿{statementBalance}, minimum ฿{minimumPayment}",
      EVENT_CARD_INTEREST_APPLIED: "Interest charged",
      EVENT_CARD_INTEREST_APPLIED_body: "฿{amount} interest charged on {accountName}",
      EVENT_RECONCILE_MISMATCH: "Balance mismatch",
      EVENT_RECONCILE_MISMATCH_body:
        "{accountName} is off by ฿{difference} from your recorded balance",
      EVENT_CROSS_CURRENCY_TRANSFER: "Transfer complete",
      EVENT_CROSS_CURRENCY_TRANSFER_body: "Transferred from {fromAccount} to {toAccount}",
      EVENT_RECURRING_POSTED: "Recurring item posted",
      EVENT_RECURRING_POSTED_body: "{name} was recorded for this period",
      EVENT_SECURITY_NEW_SIGN_IN: "New sign-in",
      EVENT_SECURITY_NEW_SIGN_IN_body:
        "New sign-in from {device}. If this wasn't you, secure your account.",
      EVENT_SECURITY_PASSWORD_CHANGED: "Password changed",
      EVENT_SECURITY_PASSWORD_CHANGED_body: "Your password was changed successfully.",
      EVENT_SECURITY_SESSION_REVOKED: "Signed out remotely",
      EVENT_SECURITY_SESSION_REVOKED_body: "One of your sessions was signed out.",
      EVENT_ACCOUNT_DEACTIVATED: "Account deactivation scheduled",
      EVENT_ACCOUNT_DEACTIVATED_body:
        "Your account will be deleted on {date}. Sign in before then to cancel.",
      EVENT_ACCOUNT_STATUS_CHANGED: "Account status changed",
      EVENT_ACCOUNT_STATUS_CHANGED_body: "Your account status changed to {status}.",
      EVENT_REPORT_SUBMITTED: "Report received",
      EVENT_REPORT_SUBMITTED_body: "Thanks — we received your report and will review it.",
      EVENT_REPORT_STATUS_CHANGED: "Report updated",
      EVENT_REPORT_STATUS_CHANGED_body: "Your report status changed to {status}.",
      EVENT_ANNOUNCEMENT: "Announcement",
      ALERT_NO_BUDGET: "No budget set",
      ALERT_NO_BUDGET_body: "You haven't set a budget for this month yet.",
      ALERT_CREDIT_LIMIT: "Approaching credit limit",
      ALERT_CREDIT_LIMIT_body: "{accountName} is close to its credit limit.",
      ALERT_NEGATIVE_BALANCE: "Negative balance",
      ALERT_NEGATIVE_BALANCE_body: "{accountName} has a negative balance.",
      ALERT_DELETION_PENDING: "Account deletion pending",
      ALERT_DELETION_PENDING_body:
        "Your account is scheduled for deletion on {date}. Sign in to cancel.",
    },
  },
  admin: {
    contactMessages: {
