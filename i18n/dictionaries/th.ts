export const thDictionary = {
  ...
  home: {
    ...
    hero: {
      ...
      subheadline:
        "ระบบบริหารรายรับ–รายจ่ายที่รองรับหลายบัญชี บัตรเครดิตแบบมีรอบบิล และคำนวณยอดอย่างแม่นยำ",
      primaryCta: "เริ่มใช้งาน",
      secondaryCta: "ดูว่าทำอะไรได้บ้าง",
      previewLabel: "ตัวอย่างหน้าหลัก",
    },
    coreValue: {
      structured: {
        title: "บัญชีแบบมีโครงสร้าง",
        description:
          "ไม่ใช่แค่บันทึกรายการ รองรับรอบบิลและแบ่งจ่ายค่าบัตรเครดิตได้",
      },
      multiAccount: {
        title: "รองรับหลายบัญชี",
        description: "ใช้ได้ทั้งบัญชีธนาคาร กระเป๋าเงิน เงินสด และบัตรเครดิต",
      },
      deterministic: {
        title: "ยอดเงินแม่นยำ",
        description:
          "คำนวณจากรายการจริง ไม่มีตัวเลขลอยหรือคำนวณผิดพลาด",
      },
    },
    features: {
      creditCard: {
        ...
        items: [
          "รอบบิลชัดเจน ติดตามได้",
          "แจ้งเตือนวันครบกำหนดชำระ",
          "จ่ายขั้นต่ำหรือจ่ายเต็มได้",
          "แบ่งโอนชำระจากบัญชีอื่นได้",
        ],
      },
      transfer: {
        title: "โอนระหว่างบัญชี",
        items: [
          "โอนเงินระหว่างบัญชีได้",
          "ระบบคิดยอดอัตโนมัติถูกต้อง",
      ...
      importExport: {
        ...
        items: [
          ...
          "เช็คกับใบยอดบัญชีได้",
          "ตรวจสอบประวัติรายการได้",
        ],
      },
      releaseTracking: {
        title: "ประวัติการอัปเดต",
        items: [
          "ดูเวอร์ชันย้อนหลังได้",
          "มีหมายเหตุการอัปเดตทุกครั้ง",
          "แยกประเภทการเปลี่ยนแปลง (เพิ่ม/เปลี่ยน/แก้ไข/ลบ)",
        ],
      },
    },
    engine: {
      title: "ออกแบบมาเพื่อจัดการเงินจริง ไม่ใช่แค่จดบันทึก",
      description: "ระบบทำงานด้วยหลักการ:",
      bullets: [
        "บันทึกรายการอย่างเป็นระบบ",
        "แยกบัญชีบัตรเครดิตชัดเจน",
        "ติดตามรอบบิลตามจริง",
        "จัดการวงจรชีวิตรายการได้",
        "โครงสร้างข้อมูลชัดเจน ดูแลง่าย",
      ],
    },
    cta: {
      headline: "เริ่มจัดระเบียบการเงินของคุณวันนี้",
      button: "เริ่มใช้งาน",
    },
    footer: {
      version: "v{version}",
      techStack: "",
      releaseNotes: "หมายเหตุแพตช์",
