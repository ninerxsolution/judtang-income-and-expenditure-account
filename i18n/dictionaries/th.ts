export const thDictionary = {
  ...
  dashboard: {
    ...
    spendingEfficiency: {
      subtitle:
        "กำหนดเป้ารายวันเป็นบาท แล้วเทียบกับรายจ่ายจริงที่ผ่านมา (รายจ่าย + ดอกเบี้ย แปลงเป็นบาทโดยประมาณ)",
      dailyTargetLabel: "เป้าต่อวัน (บาท)",
      dailyTargetHelp: "ตั้ง 0 หากต้องการดูเฉพาะยอด โดยยังไม่เทียบเส้นเป้า",
      periodPrev: "ก่อนหน้า",
      periodNext: "ถัดไป",
      ...
      totalIfOnTarget: "หากตามเป้า (เป้า × จำนวนวัน)",
      difference: "เทียบเป้า",
      daysOver: "วันที่เกินเป้า",
      daysNotOver: "วันที่ตามเป้าหรือไม่ถึง",
      calendarTitle: "ปฏิทิน",
      excludeCategoriesLabel: "หมวดที่ยกเว้นจากการคำนวณ",
      excludeAll: "ยกเว้นทั้งหมด",
      clearExcluded: "ล้างการยกเว้น",
      excludeCount: "ยกเว้น {count} หมวด",
      overBy: "เกิน {amount}",
      underBy: "ต่ำกว่า {amount}",
      thbNote: "ใช้รายการรายจ่าย (EXPENSE) และดอกเบี้ย (INTEREST) มูลค่าโดยประมาณในบาท ตามแนวเดียวกับส่วนอื่นของแอป",
    },
    home: {
      subtitle:
